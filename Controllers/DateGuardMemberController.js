...
async function sendSMS(username, phoneNumber, smsCode, token) {
  try {
    const message = await client.messages.create({
      body: `${username} has requested you to be one of her Guardians Please click on the link and enter the following ${process.env.REACT_SMS_CODE_URL}/${token} Please Enter this code ${smsCode}`,
